...
public class SqoopCommandTemplate 
{
	...
	public static final String SQOOP_TERADATA_2_HDFS_BY_SQL = "sqoop import --driver {0} --connect {1} --username {2} --password {3} --query {4} --target-dir {5} --null-string {6} --null-non-string {7} --m {8}";

	public static final String SQOOP_TERADATA_2_HDFS = "sqoop import --driver {0} --connect {1} --username {2} --password {3} --table {4} --target-dir {5} --null-string {6} --null-non-string {7} --m {8}";
}
